...
@section('content')
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-10 bg-white p-3">
            <form 
            {{-- va hacia el metodo update en el controlador y se le pasa el id del perfil --}}
                action="{{route('perfiles.update',['perfil' =>$perfil->id])}}"
                method="POST"
                enctype="multipart/form-data"
            >
                @csrf{{-- para agregar el token, de lo contrario da error --}}
                @method('PUT')
                <div class="form-group">
                    ...
                    @error('nombre') {{--si hay un error en nombre entonces: --}}
                ...
                <div class="form-group">
                    ...
                    @error('url') {{--si hay un error en url entonces: --}}
                        <span class="invalid-feedback d-block" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    @error('biografia'){{--si hay un error en categoria entonces: --}}
                        <span class="invalid-feedback d-block" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
                    @enderror
